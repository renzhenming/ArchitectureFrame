...
import com.rzm.commonlibrary.general.imageloader.cache.MemoryCache;
...
public class ImageLoaderConfig {
     ...
     * 默认线程数
     */
    private int dispatcherCount = Runtime.getRuntime().availableProcessors();
    ...
    public static class Builder{
         ...
         * @return
         */
        public Builder setDispatcherCount(int dispatcherCount){
            config.dispatcherCount = dispatcherCount;
            return this;
        }
